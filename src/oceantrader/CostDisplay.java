...
public class CostDisplay {
    ...
    private void initGUI() {
        ...
        basePriceTF.setFont(bestFont); // NOI18N
        jScrollPane1.setViewportView(basePriceTF);

        timeTF.setEditable(false);
        timeTF.setBackground(backgroundColor);
        timeTF.setBorder(null);
        timeTF.setFont(bestFont); // NOI18N
        jScrollPane2.setViewportView(timeTF);

        tradeTF.setEditable(false);
        tradeTF.setBackground(backgroundColor);
        tradeTF.setBorder(null);
        tradeTF.setFont(bestFont); // NOI18N
        jScrollPane3.setViewportView(tradeTF);

        finalPriceLbl.setFont(new Font("Comic Sans MS", 1, 18)); // NOI18N
        finalPriceLbl.setText("Final Price:");


        finalPriceTF.setEditable(false);
        finalPriceTF.setFont(new Font("Comic Sans MS", 0, 18)); // NOI18N
        finalPriceTF.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new Color(102, 0, 0)));



        semiColonLbl.setFont(new java.awt.Font("Cantarell Light", 0, 48)); // NOI18N
